...
parser.add_argument('--mean_fc', type=float, default=2., help='Average fixed cost of firms')
parser.add_argument('--var_fc', type=float, default=1., help='Variance of fixed cost of firms')
parser.add_argument('--mean_sigma', type=float, default=2., help='Average sigma parameter of agents')
parser.add_argument('--var_sigma', type=float, default=0.1, help='Variance of sigma parameter of agents')
...
def main():
    ...
    eql_log_prices = find_equilibrium_prices(args.n_products, args.n_assets, args.n_firms, args.n_agents, args.theta,
                                             args.alpha, args.beta, args.mean_fc, args.var_fc, args.mean_sigma,
                                             args.var_sigma, args.scale, args.T, args.max_iter, args.step_size,
                                             args.tol, key)
    end_time = time.time()
